  ...
  return (
    <section className="pb-16 lg:py-24">
      <div className="container">
        ...
        <p className="uppercase font-semibold tracking-widest bg-gradient-to-r from-emerald-300 to-sky-400 text-transparent bg-clip-text text-center">Real World Course</p>

        </div>
        <h2 className="font-serif text-3xl md:text-5xl text-center mt-6">Feautured Courses</h2>
        <p className="text-center text-white/60 mt-4 md:text-lg lg-text-xl  max-w-md mx-auto">List of courses</p>
